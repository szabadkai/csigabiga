(() => {
    ...
    function createVeggie() {
        ...
        const typePool = ["carrot", "tomato", "lettuce", "broccoli", "eggplant"];
    ...
    function drawVeggie(v) {
        ...
        switch (v.type) {
            case "carrot": {
                ...
                ctx.beginPath();
                ctx.ellipse(-r * 0.5, 0, r * 0.25, r * 0.5, -Math.PI / 6, 0, Math.PI * 2);
                ctx.ellipse(-r * 0.7, -r * 0.2, r * 0.22, r * 0.45, Math.PI / 6, 0, Math.PI * 2);
                ctx.fill();
                break;
            }
            case "tomato": {
                ...
                for (let i = 0; i < 5; i++) {
                    ...
                    ctx.lineTo(Math.cos(a + Math.PI / 5) * r * 0.2, Math.sin(a + Math.PI / 5) * r * 0.2);
                }
                ctx.closePath();
                ctx.fill();
                // highlight
                ...
                ctx.beginPath();
                ctx.ellipse(-r * 0.3, -r * 0.3, r * 0.2, r * 0.35, Math.PI / 6, 0, Math.PI * 2);
                ctx.fill();
                break;
            }
            case "lettuce": {
            ...
            case "eggplant": {
                ...
                ctx.fillStyle = "#22c55e";
                ctx.beginPath();
                ctx.ellipse(-w * 0.2, -h * 0.7, w * 0.7, h * 0.35, -Math.PI / 10, 0, Math.PI * 2);
                ctx.fill();
                break;
            }
            default: {
